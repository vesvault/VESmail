...
const char *VESmail_cli_banner =
 ...
 "\n"
 "\n"
 " \x1b[1mvesmail imap\x1b[0m [--cert <path> --pkey <path> --ca <path>]\n"
 " \x1b[1mvesmail smtp\x1b[0m [--cert <path> --pkey <path> --ca <path>]\n"
 " \x1b[1mvesmail encrypt\x1b[0m -a <VESmail_account> -u <VESkey>\n"
